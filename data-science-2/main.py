...
sct.ttest_ind(can,usa,equal_var=False)[1].round(8)
...
def q4():
    ...
    weight = np.log(get_sample(athletes,'weight', n=3000))
    return sct.normaltest(weight)[1]>0.05
    pass
...
def q5():
    ...
    usa = athletes[athletes.nationality == 'USA'].height.dropna()
    return sct.ttest_ind(bra,usa,equal_var=False)[1]>0.05
    pass
...
def q6():
    ...
    bra = athletes[athletes.nationality == 'BRA'].height.dropna()
    can = athletes[athletes.nationality == 'CAN'].height.dropna()
    return sct.ttest_ind(bra,can,equal_var=False)[1]>0.05
    pass
...
def q7():
    ...
    usa = athletes[athletes.nationality == 'USA'].height.dropna()
    can = athletes[athletes.nationality == 'CAN'].height.dropna()
    return sct.ttest_ind(can,usa,equal_var=False)[1].round(8)
    pass
